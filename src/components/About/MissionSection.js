                        ...
                        <div className="col-xl-6 col-lg-6">
                            <div className="kintro-text mr-xs-0 mr-md-0 mr-lg-0 mr-70 mb-30" data-aos="fade-left"
                                ...
                                <div className="section-title-wrapper mb-25">
                                    ...
                                    <p>Somos una desconexión de la vida diaria para los apasionados de la libertad,
                                        planificamos las experiencias y aventuras por ti mientras te acompaña Nuestra
                                        Camper Van.</p>
                                </div>
                                <p className="mb-45">Misión:

                                    Ofrecer un servicio personalizado y de calidad de experiencias turísticas en camper
                                    van.
                                </p>
