                ...
                <div className="row justify-content-between">
                    <div className="col-xl-6 col-lg-6 col-md-12">
                        <div className="choose-left mb-40 mr-xs-0 mr-md-0 mr-lg-0 mr-90" data-aos="fade-up-right" data-aos-duration="1000">
                            ...
                            <p>Nosotros somos unos apasionados de la libertad, de hacer planes de vivencias, de disfrutar la vida con lo que te da, sin muchos complementos, y de poder trasmitir eso a nuestro entorno por el medio que conocemos, que tenemos experiencia y que además disfrutamos la “Van Life”..
                            </p>
