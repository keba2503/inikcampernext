                        ...
                        <div className="col-lg-6">
                            <div className="kabout mb-50" data-aos="zoom-out-down" data-swiper-autoplay="10000">
                                ...
                                <ul className="mt-20 mb-55">
                                    <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Somos una desconexión de la vida diaria para los apasionados de la libertad.</li>
                                    <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Planificamos las experiencias y aventuras por y para ti.</li>
                                    <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Te acompañara nuestra Camper Van.</li>
                                    <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Te Ofrecemos un servicio personalizado y de calidad.</li>
                                    <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Te guiamos en tús vacaciones para que no tengas preocupaciones.</li>
                                </ul>
