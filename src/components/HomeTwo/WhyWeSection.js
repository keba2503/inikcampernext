        ...
        return (
            <section className="why-we bg-grey pt-120 pb-70 position-relative fix">
                <div className="common-shape-wrapper wow slideInLeft animated" data-wow-delay="0ms"
                    ...
                    <div className="common-shape-inner wow slideInleft animated" data-wow-delay="0ms"
                        ...
                        <div className="col-xl-6">
                            <div className="why-we-left mb-40 mr-90" data-aos="fade-up-right" data-aos-duration="1000">
                                <div className="section-title-wrapper">
                                    ...
                                    <p>There are many variations of passages of but the lipsum not free as you know
                                        majority
