            ...
            <br/><br/><br/>
                <Carousel breakPoints={breakPoints} className='fondo'>
                                    ...
                                    <div className="card-3d-wrapper">
                                        <div className="card-front">
                                            <div className="pricing-wrap">
                                                ...
                                                <a href="/booking" className="link">Disponibilidad</a>
                    ...
                    <div className="">
                        ...
                        <br/> <div className="col-12 text-center align-self-center py-5">
                                        ...
                                        <div className="card-3d-wrapper">
                                            <div className="card-front">
                                                <div className="pricing-wrap">
                                                    ...
                                                    <p className="mb-1"><i className="uil uil-location-pin-alt size-22"></i></p>
                                                    <a href="/booking" className="link">Disponibilidad</a>                                                    <div className="img-wrap img-2">
                                                        <img src="https://assets.codepen.io/1462889/grass.png" />
                                                    </div>
                                                    <div className="img-wrap img-1">
